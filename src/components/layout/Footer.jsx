...
<li>- 0703313371</li>
            <li>Email: contact@immobilierdigitalaiditerrainavecacdctedivoire.cm</li>
            
            
            <li className="flex items-center gap-4 pt-2">
              <a href="https://www.tiktok.com/@immobilierdigital.aidi" target="_blank" rel="noopener noreferrer" className="p-2 bg-black text-white rounded-full hover:scale-110 transition-transform shadow-lg" title="TikTok">
                <Video className="w-4 h-4" />
              </a>
              <a href="https://wa.me/2250102415538" target="_blank" rel="noopener noreferrer" className="p-2 bg-green-500 text-white rounded-full hover:scale-110 transition-transform shadow-lg" title="WhatsApp">
